        ...
        blocks += `
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">                
                <div class="card bgColorForContainer" style="margin-bottom: 20px;" id="edit-card">
                    <img class="card-img-top" src="${country.flags.png}" alt="Vlajka" style="height: 150px; object-fit: cover;">
                    <div class="card-body">
          ...
          .then(data => {
            ...
            ModalFooter.innerHTML = `
              <div id="footer-modal-edit" class="w-100 p-0 m-0">
                <img src="${country.flags.png}" alt="Vlajka" style="height: 165px; object-fit: cover;">
              </div>
            `;
          })
          .catch(error => {
